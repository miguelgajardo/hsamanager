			...
			<div class="col-xl-12 col-lg-11">
				<div class="card shadow mb-4">
					...
					<div class="card-body">
						...
						<form action="/Admin/adminusuarios?action=registrar_usuario" method="POST">
							<div class="form-group row">
								<div class="col-md-3">
									<input type="text" class="form-control" placeholder="RUT Usuario" name="nurut">
									<small class="form-text text-muted">RUT completo sin puntos ni guión</small>
								</div>
								<div class="col-md-4">
									<input type="text" class="form-control" name="nunombre" placeholder="Nombre(s)">
								</div>
								<div class="col-md-5">
									<input type="text" class="form-control" name="nuapellido" placeholder="Apellido(s)">
								</div>
							</div>
							<div class="form-group row">
								<div class="col-md-6">
									<input type="text" class="form-control" name="numail" placeholder="Correo Electrónico">
								</div>
								<div class="col-md-6">
									<input type="password" class="form-control" name="nupass" placeholder="Contraseña">
								</div>
							</div>
							<div class="form-group row">
								<div class="col-md-6">
