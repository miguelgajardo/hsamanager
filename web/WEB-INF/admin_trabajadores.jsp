						...
						%>	
							<tr>
								...
								<td>
									...
									<a type="button" class="btn btn-secondary btn-sm" href="/Admin/admintrabajadores?go_to=modificar_trabajador&rut_trabajador=<%= trabajador.getRut() %>"><i class="fas fa-edit"></i></a>
									<a type="button" class="btn btn-secondary btn-sm" href="/Admin/admintrabajadores?go_to=eliminar_trabajador&rut_trabajador=<%= trabajador.getRut() %>"><i class="fas fa-trash-alt"></i></a>
								</td>
							</tr>
						<% } %>
						</tbody>
