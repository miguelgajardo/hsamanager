...
<%@page session="true"%>
<%
String rutUsuarioEliminar = request.getAttribute("rutusuarioeliminar").toString();
...
<title>Eliminar <%= usuario.getNombre() %> <%= usuario.getApellido() %> - HSA Auditores</title>
...
<div id="content-wrapper" class="d-flex flex-column">
	...
	<div class="container-fluid">
		...
		<div class="d-sm-flex align-items-center justify-content-between mb-4">
			<h1 class="h3 mb-0 text-gray-800">Eliminar Usuario(a)</h1>
		</div>
		...
		<div class="row">
			...
			<div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
				<h6 class="m-0 font-weight-bold text-primary">Datos de Usuario(a) a Eliminar</h6>
			</div>
			<div class="card-body">
			
				<!-- Mensaje de Advertencia Eliminar Trabajador -->
				<% out.write("<div class=\"alert alert-danger\" role=\"alert\">");
				out.write("<strong> Atención! Usted va a eliminar al usuario:" + "</strong>" + " <strong>" 
				+ usuario.getNombre() + " " + usuario.getApellido() + " </strong>"
				+ "<br>Esta acción <strong>no eliminará</strong> las empresas asociadas.");
				out.write("</div>");
				%>
